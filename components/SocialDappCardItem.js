...
const style = {
    socialDappCardWrapper: `w-full h-full absolute`,
  ...
  const SocialDappCardItem = ({ card }) => {
    const { handleRightSwipe, currentAccount } = useContext(SocialDappContext)
    ...
    return (
      <TinderCard
        className={style.socialDappCardWrapper}
  ...
  export default SocialDappCardItem;
